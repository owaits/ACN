...
{
    public class EndpointResponders
    {
        public class Get:RdmRequestPacket
        {
            public Get():base(RdmCommands.Get,RdmParameters.EndpointResponders)
            {
            }
        ...
        {
            public Reply()
                : base(RdmCommands.GetResponse, RdmParameters.EndpointResponders)
            {             
            }
