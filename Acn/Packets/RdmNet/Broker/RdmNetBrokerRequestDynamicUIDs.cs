...
{
    public class RdmNetBrokerRequestDynamicUIDsPacket : RdmNetBrokerPacket
    {
        public RdmNetBrokerRequestDynamicUIDsPacket() : base(RdmNetBrokerProtocolIds.RequestDynamicUIDS)
        {
        }
