...
{
    public class RdmNetBrokerClientEntryChangePacket : RdmNetBrokerPacket
    {
        public RdmNetBrokerClientEntryChangePacket() : base(RdmNetBrokerProtocolIds.ClientEntryChange)
        {
        }
