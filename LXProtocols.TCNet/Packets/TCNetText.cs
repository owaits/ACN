...
{
    /// <summary>
    /// Send and Receive Text Data Packets to control nodes remotely.
    /// </summary>
    /// <remarks>
    /// Response Required
    /// </remarks>
    /// <seealso cref="LXProtocols.TCNet.Packets.TCNetHeader" />
    public class TCNetTextData:TCNetHeader
    {
        #region Setup and Initialisation

        /// <summary>
        /// Initializes a new instance of the <see cref="TCNetTextData"/> class.
        /// </summary>
        public TCNetTextData() : base(MessageTypes.TextData)
        {
        }
